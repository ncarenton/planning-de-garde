...
public class DataTest {
    ...
    public void getWorkerPays_should_work_default_data() throws IOException {
        ...
        // Then
        assertThat(workerPays)
            .isEqualTo(
                objectMapper.readValue(getResourceAsStream("/level1/output.json"), Output.class).getWorkers());
    }
        ...
        assertThat(workerPays)
            .isEqualTo(
                objectMapper.readValue(
                    getResourceAsStream("/level1/output_missing_worker.json"), Output.class).getWorkers());
    }
    ...
    public void getWorkerPays_should_work_empty_shifts() throws IOException {
        ...
        assertThat(workerPays)
            .isEqualTo(objectMapper.readValue(
                getResourceAsStream("/level1/output_empty_shifts.json"), Output.class).getWorkers());
    }
    ...
    public void getWorkerPays_should_work_duplicate_workers_duplicate_shifts() throws IOException {
        ...
        assertThat(workerPays)
            .isEqualTo(objectMapper.readValue(
                getResourceAsStream("/level1/output.json"), Output.class).getWorkers());
    }
